			...
			<div class="menu_block">
				...
				<div class="container clearfix">
					...
					<div class="logo pull-left">
						<a href="<%=request.getContextPath()%>/start" ><img style="width:200px; heigth:160px" src="<%=request.getContextPath()%>/resources/images/logo/logo.jpg" id="logo" alt="성공하는 사람들" /></a>
					</div><!-- //LOGO -->
					
					<!-- SEARCH FORM -->
					<div id="log-in" class="pull-right">
						<form method="get" action="#">
							<a href="#"><img src="<%=request.getContextPath()%>/resources/images/service/login.jpg" style="width:63px"><br>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 padbot30">
					...
					<div class="recent_posts_small clearfix">
						<div class="post_item_img_small">
							<img src="<%=request.getContextPath()%>/resources/images/blog/1.jpg" alt="" />
						</div>
					...
					<div class="recent_posts_small clearfix">
						<div class="post_item_img_small">
							<img src="<%=request.getContextPath()%>/resources/images/blog/2.jpg" alt="" />
						</div>
						<div class="post_item_content_small">
					...
					<div class="recent_posts_small clearfix">
						<div class="post_item_img_small">
							<img src="<%=request.getContextPath()%>/resources/images/blog/3.jpg" alt="" />
						</div>
						<div class="post_item_content_small">
